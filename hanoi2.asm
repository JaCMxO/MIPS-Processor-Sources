...
main:
	...
	addi	$a2, $a1, 4				#pass start direction of tower B pointer
	addi	$a3, $a1, 8				#pass start direction of tower C pointer
...
initCycle:
	...
	sw		$zero, ($a2)			#store zero in tower B
	sw		$zero, ($a3)			#store zero in tower C
	addi	$a1, $a1, 0x20			#point to next store location
	addi	$a2, $a2, 0x20			#point to next store location
	addi	$a3, $a3, 0x20			#point to next store location
